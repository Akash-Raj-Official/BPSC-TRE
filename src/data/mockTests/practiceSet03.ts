...
const TEST_ID = 'practice-set-03';

/**
 * Practice Set 3 — a complete paper covering every part of the syllabus:
 * Paper I (Hindi + English) and all seven Paper II subjects.
 *
 * Draws from offset 2 of each question bank, so it shares no question with
 * the other practice sets.
 */
export const practiceSet03: MockTest = {
  id: TEST_ID,
  title: {
    hindi: 'BPSC TRE प्रैक्टिस सेट 3',
    english: 'BPSC TRE Practice Set 3',
  },
  description: {
    hindi:
  ...
  difficulty: 'moderate',
  demo: true,
  questions: buildPracticeSet(TEST_ID, 2),
};
