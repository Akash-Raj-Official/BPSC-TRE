...
const TEST_ID = 'practice-set-07';

/**
 * Practice Set 7 — a complete paper covering every part of the syllabus:
 * Paper I (Hindi + English) and all seven Paper II subjects.
 *
 * Draws from offset 6 of each question bank, so it shares no question with
 * the other practice sets.
 */
export const practiceSet07: MockTest = {
  id: TEST_ID,
  title: {
    hindi: 'BPSC TRE प्रैक्टिस सेट 7',
    english: 'BPSC TRE Practice Set 7',
  },
  description: {
    hindi:
  ...
  difficulty: 'hard',
  demo: true,
  questions: buildPracticeSet(TEST_ID, 6),
};
