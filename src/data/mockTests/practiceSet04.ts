...
/**
 * Practice Set 4 — a complete paper covering every part of the syllabus:
 * Paper I (Hindi + English) and all seven Paper II subjects.
 *
 * Draws from offset 3 of each question bank, so it shares no question with
 * the other practice sets.
 */
export const practiceSet04: MockTest = {
  id: TEST_ID,
  title: {
    hindi: 'BPSC TRE प्रैक्टिस सेट 4',
    english: 'BPSC TRE Practice Set 4',
  },
  description: {
    hindi:
  ...
  difficulty: 'moderate',
  demo: true,
  questions: buildPracticeSet(TEST_ID, 3),
};
